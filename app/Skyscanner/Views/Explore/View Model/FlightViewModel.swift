...
struct FlightViewModel {
    ...
    init(outboundInformation: FlightInformationViewModel, inboundInformation: FlightInformationViewModel) {
...
extension FlightViewModel {
    ...
    public static func getTestViewModel() -> [FlightViewModel] {
        ...
        let flightViewModel = FlightViewModel(outboundInformation: outboundInformation, inboundInformation: inboundInformation)
