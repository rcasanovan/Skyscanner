...
* Please exclude generated files from your submission. When we review your code it will be built in Xcode. Please use a stable, non-beta version of Xcode for the development.
