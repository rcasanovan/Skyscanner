...
struct FlightViewModel {
    ...
    init(outboundInformation: FlightInformationViewModel, inboundInformation: FlightInformationViewModel, price: String) {
...
extension FlightViewModel {
    ...
    public static func getTestViewModel() -> [FlightViewModel] {
        ...
        let flightViewModel = FlightViewModel(outboundInformation: outboundInformation, inboundInformation: inboundInformation, price: "80€")
