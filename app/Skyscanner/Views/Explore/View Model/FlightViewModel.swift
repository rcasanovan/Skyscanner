...
struct FlightViewModel {
    ...
    init(outboundInformation: FlightInformationViewModel, inboundInformation: FlightInformationViewModel, price: String, bookingInformation: String) {
...
extension FlightViewModel {
    ...
    public static func getTestViewModel() -> [FlightViewModel] {
        ...
        let flightViewModel = FlightViewModel(outboundInformation: outboundInformation, inboundInformation: inboundInformation, price: "80€", bookingInformation: "2 bookings required")
